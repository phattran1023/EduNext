...
namespace EduNext.Controllers
{
	public class StudentController : Controller
	{
		...
		{
			var students = await _databaseContext.Students
		...
		[HttpPost]
		public async Task<IActionResult> EditStudent([FromBody] StudentEditViewModel model)
		{
			try
			{
				var student = await _databaseContext.Students.FindAsync(model.Id);
				var departmentUpdate = await _databaseContext.Departments.FindAsync(model.DepartmentId);

				if (student != null && departmentUpdate != null)
				{
					student.Name = model.Name;
					student.DepartmentId = departmentUpdate.DepartmentId;
